...
export default function RoulettePage() {
  ...
  useEffect(() => {
    (window as unknown as { admin: () => void }).admin = () => setShowAdmin(true);
    return () => { delete (window as unknown as { admin?: () => void }).admin; };
  }, []);
  ...
  const handleSpin = useCallback(() => {
    ...
    wheelRef.current?.spin(winning, () => {
      ...
      if (infiniteBalance) {
        setBalance((prev) => { const n = prev + winAmount; saveBalance(n); return n; });
      } else {
        setBalance((prev) => { const n = prev - betTotal + winAmount; saveBalance(n); return n; });
      }
    ...
    <>
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 9, color: "rgba(201,168,76,0.6)", letterSpacing: 2, textTransform: "uppercase" }}>Balance</div>
          <div style={{ fontSize: 14, fontWeight: "bold", color: balance > 0 ? "#f0d878" : "#e74c3c", fontFamily: "Georgia, serif" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16, flex: 1, minWidth: 320 }}>
            ...
            <div style={{
              ...
              <ChipSelector
                ...
                disabled={isSpinning}
                remainingBalance={infiniteBalance ? Infinity : balance - totalBet}
              />
            </div>
